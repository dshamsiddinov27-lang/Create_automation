...
test.describe('Todo List Application', () => {
  test('Verify user can uncomplete completed todo', async ({ page }) => {
    ...
    await expect(page.getByTestId('todo-text-1')).not.toHaveClass(/completed/);
  });
});